	...
	public static function show_about_page() { ?>
		<div class="wrap sitewide_sales_admin">
			<div class="swsales-wrap">
				...
				<p><?php echo wp_kses( __( 'Check out the Sitewide Sales documentation site for additional setup instructions, sample landing page and banner content, as well as developer documentation to further extend the templates, reporting, and integration options.', 'sitewide-sales' ), $allowed_html ); ?></p>
