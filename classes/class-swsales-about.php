	...
	public static function show_about_page() { ?>
		<div class="wrap sitewide_sales_admin">
			<div class="swsales-wrap">
				...
				<p><?php 
				/* Translators: 1: Paid Memberships Pro, 2: WooCommerce, 3: Easy Digital Downloads */
				echo wp_kses( sprintf( __( 'We currently offer integration for <a href="%1$s" title="Paid Memberships Pro" target="_blank">Paid Memberships Pro</a>, <a href="%2$s" title="WooCommerce" target="_blank">WooCommerce</a>, and <a href="%3$s" title="Easy Digital Downloads" target="_blank">Easy Digital Downloads</a>.', 'sitewide-sales' ), 'https://sitewidesales.com/modules/paid-memberships-pro/?utm_source=sitewide-sales&utm_medium=about&utm_campaign=module-pmpro', 'https://sitewidesales.com/modules/woocommerce/?utm_source=sitewide-sales&utm_medium=about&utm_campaign=module-wc', 'https://sitewidesales.com/modules/easy-digital-downloads/?utm_source=sitewide-sales&utm_medium=about&utm_campaign=module-edd' ), $allowed_html ); ?></p>
				<p><?php 
				/* Translators: %s Custom Module Link */
				echo wp_kses( sprintf( __( 'There is also a <a href="%s" title="Custom Module" target="_blank">custom module</a> you can use to track performance with any other platforms you choose.', 'sitewide-sales' ), 'https://sitewidesales.com/modules/custom-module/?utm_source=sitewide-sales&utm_medium=about&utm_campaign=module-custom' ), $allowed_html ); ?></p>
