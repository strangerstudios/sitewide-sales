        ...
        <div class="wrap sitewide_sales_admin">
            ...
            <p>
				<?php if ( ! swsales_license_is_valid() ) { ?>
					...
					<a class="button button-hero" href="https://www.strangerstudios.com/wordpress-plugins/sitewide-sales/?utm_source=plugin&utm_medium=swsales-license&utm_campaign=swsales-checkout&utm_content=view-license-details" target="_blank"><?php echo esc_html( 'View Support License Details', 'sitewide-sales' ); ?></a>
				<?php } else { ?>
					...
					<a class="button button-hero" href="https://www.strangerstudios.com/login/?redirect_to=%2Fnew-ticket%2F%3Futm_source%3Dplugin%26utm_medium%3Dswsales-license%26utm_campaign%3Dsupport%26utm_content%3Dnew-support-ticket" target="_blank"><?php echo esc_html( 'Open Support Ticket', 'sitewide-sales' ); ?></a>
				<?php } ?>
			</p>
            ...
            <p><a href="https://www.strangerstudios.com/wordpress-plugins/sitewide-sales/?utm_source=plugin&utm_medium=swsales-license&utm_campaign=swsales-checkout&utm_content=view-license-option" target="_blank"><?php echo esc_html( 'View Support License Options &raquo;', 'sitewide-sales' ); ?></a></p>
            </div> <!-- end swsales-text -->
