...
function swsales_register_blocks() {
    register_block_type( SWSALES_DIR . '/blocks/build/countdown-timer' );
    register_block_type( SWSALES_DIR . '/blocks/build/sale-content' );
    register_block_type( SWSALES_DIR . '/blocks/build/sale-period-setting' );
}
